...
const AddProduct = (props) => {
    ...
    const handleOnChange = event => {
        ...
        // Kiểm tra nếu là originalPrice hoặc discountPrice
        if ((name === 'originalPrice' || name === 'discountPrice') && value < 0) {
            toast.error("Giá không được phép là số âm");
            return; // Không cập nhật state nếu giá là số âm
        }
