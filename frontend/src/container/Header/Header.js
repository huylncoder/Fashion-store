            ...
            <div className="main_menu">
                <div className="container">
                    <nav className="navbar navbar-expand-lg navbar-light w-100">
                        ...
                        {/* logo cửa hàng */}
                            <img src="resources/img/logo/logo1.png" alt="" style={{width: '137px'}}/>
                        </NavLink>
                                    ...
                                    <ul className="nav navbar-nav center_nav pull-right">
                                        <li className="nav-item">
                                            <NavLink exact to="/" className="nav-link"
                                                activeClassName="selected" activeStyle={{ color: '#1150ab' }}>
                                                Trang chủ
                                            </NavLink>
                                        </li>
                                        <li className="nav-item ">
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/about" className="nav-link" activeClassName="selected" activeStyle={{ color: '#1150ab' }}>
                                            Giới thiệu
                                            </NavLink>
                                        </li>
                                    </ul>
